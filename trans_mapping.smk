...
rule intrachromosomal_LD_estimate:
    input:
        ...
        cis = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/results/EQTL/results/ALL.cis_qtl_fdr0.05.txt",
        trans = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/results/EQTL/results/ALL_trans_FDR_corrected.txt",
        script = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/bin/EQTL/Intra_trans_analysis.R"
    output:
...
rule interchromosomal_LD_estimate:
    input:
        ...
        cis = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/results/EQTL/results/ALL.cis_qtl_fdr0.05.txt",
        trans = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/results/EQTL/results/ALL_trans_FDR_corrected.txt",
        script = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/bin/EQTL/inter_trans_analysis.R"
    ...
    output:
        ...
        permuteraw = "/home/workspace/jogrady/eqtl_study/eqtl_nextflow/results/EQTL/transQTL/inter_trans_cis_permutation_raw.txt",
    ...
    shell:
        '''
        Rscript {input.script} {input.vcf} {input.cis} {input.trans} {output.trans_variants_4_LD} {output.inter_chrom_LD} \
        {output.null_variants_4_LD} {output.null_inter_chrom_LD} {output.plot1} {output.permute_Pval} {output.permuteraw} \
        {output.links} {output.final_inter_trans} 
        '''
rule circos_plot2:
    input:
